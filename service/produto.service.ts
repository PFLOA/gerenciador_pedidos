...
import {
	...
	CriarProdutoRequest,
	ProdutoModel,
} from './models/produto/produto.model';

export const buscarProdutosPorFiltro = async (
	filtro: ToQueryParams<BuscarProdutosFiltroRequest>
): Promise<BuscarProdutosFiltroResponse> => {
	return await BuscarPorFiltro(EndPoints.Produto, filtro);
};
export const buscarProdutoPorGuid = async (
	guid: string
